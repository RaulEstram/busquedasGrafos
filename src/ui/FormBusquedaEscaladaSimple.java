...
public class FormBusquedaEscaladaSimple extends javax.swing.JPanel {

    public FormBusquedaEscaladaSimple() {
        initComponents();
    }
    ...
    private void ButtonCalcularMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonCalcularMouseClicked
        try {
            ...
            try {
                ...
                HillClimbing dfs = new HillClimbing(nodos.getData(), distancias.getData());
