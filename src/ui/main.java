...
public class main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ButtonNodosDistancias.setText("<html><p style=\"text-align:center\">Seleccionar Nodos y Distancias</p></html>");
        ...
        ButtonBProdundidad.setText("Busqueda por Profundidad");
        ...
        ButtonEscaladaSimple.setText("Busqueda Escalada Simple");
        ...
        ButtonPrimeroMejor.setText("Busqueda Primero Mejor");
    ...
    private void ButtonNodosDistanciasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonNodosDistanciasMouseClicked
        // Mostramos el contenido de nuestro JPanel pertinente en nuestro Form
        FormSeleccionNodosDistancias fh = new FormSeleccionNodosDistancias();
        fh.setSize(690, 325);
        fh.setLocation(0, 0);
        PanelContent.removeAll();
        PanelContent.add(fh, BorderLayout.CENTER);
    ...
    private void ButtonBProdundidadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonBProdundidadMouseClicked
        // Mostramos el contenido de nuestro JPanel pertinente en nuestro Form
        FormBusquedaProfunda fh = new FormBusquedaProfunda();
        fh.setSize(690, 325);
        fh.setLocation(0, 0);
        PanelContent.removeAll();
        PanelContent.add(fh, BorderLayout.CENTER);
    ...
    private void ButtonEscaladaSimpleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonEscaladaSimpleMouseClicked
        // Mostramos el contenido de nuestro JPanel pertinente en nuestro Form
        FormBusquedaEscaladaSimple fh = new FormBusquedaEscaladaSimple();
        fh.setSize(690, 325);
        fh.setLocation(0, 0);
        PanelContent.removeAll();
        PanelContent.add(fh, BorderLayout.CENTER);
    ...
    private void ButtonPrimeroMejorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonPrimeroMejorMouseClicked
        // Mostramos el contenido de nuestro JPanel pertinente en nuestro Form
        FormBusquedaPrimeroMejor fh = new FormBusquedaPrimeroMejor();
        fh.setSize(690, 325);
        fh.setLocation(0, 0);
        PanelContent.removeAll();
        PanelContent.add(fh, BorderLayout.CENTER);
